...
\pgfplotsset{every axis/.style={xticklabel style={align=right}}}
...
\tikzstyle{sensor}=[draw, fill=blue!20, text width=5em, text centered, minimum width=2cm, minimum height=0.75cm,node distance=0.25cm]
\tikzstyle{sensorbig}=[sensor, minimum width=2cm]
