...
The following text lists each of the implementations that were created along with a short discussion of the results. Note that an incremental approach was taken, implying that changes to, as an example, the optimised version of the algorithm are also reflected by the NEON one, if applicable.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \subimport{resources/}{memory_dynamic.tikz}
