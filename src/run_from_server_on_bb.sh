...
##--------mv results bb-> server--------##
scp -oKexAlgorithms=+diffie-hellman-group1-sha1 root@192.168.0.202:/tmp/tracking_result.coords ~/casper/tracking/

diff -s ~/casper/tracking/reference.coords ~/casper/tracking/tracking_result.coords
